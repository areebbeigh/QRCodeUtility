...
package com.areebbeigh.qrcodeutility.generator.schemes;
...
public class Email extends QRCodeScheme {
    ...
    // Comprehensive email scheme
    // Check https://www.nttdocomo.co.jp/english/service/developer/make/content/barcode/function/application/mail/
    ...
    /**
     * @param type The type of email object to create.
     *             <p>{@link MailType#SIMPLE} object string representation: mailto:example@example.com</p>
     *             <p>
     *                 {@link MailType#COMPREHENSIVE} object string representation:
     *             MATMSG:
     *             TO: example@example.com;
     *             SUB: Subject;
     *             BODY: Hello example, so long no see!;;
     *             </p>
     */
    ...
    /**
     * See {@link Email#Email(MailType)} examples
     */
    @Override
